...
namespace SR\Reflection\Introspection\Type\ConstantAware;

use SR\Reflection\Introspection\Type\Aware\IdentityDeclaringClassAwareAccessorsInterface;
...
interface IdentityAwareAccessorsInterface extends IdentityNameAwareAccessorsInterface, IdentityNamespaceAwareAccessorsInterface,
                                                  IdentityDeclaringClassAwareAccessorsInterface
{
}
